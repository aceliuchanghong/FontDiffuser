...
if __name__ == '__main__':
    ...
    python dataset/font2image_example2.py --font_in /mnt/data/llch/free-font/new_font/kaiti --image_out data_examples/basic
    python dataset/font2image_example2.py --font_in /mnt/data/llch/free-font/new_font/shouxie --image_out data_examples/basic
    python dataset/font2image_example2.py --font_in /mnt/data/llch/free-font/new_font/songti --image_out data_examples/basic
    python dataset/font2image_example2.py --font_in /mnt/data/llch/free-font/new_font/zhuangshiti --image_out data_examples/basic
    """
