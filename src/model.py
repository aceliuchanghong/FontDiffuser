...
class FontDiffuserModel(ModelMixin, ConfigMixin):
    """
    Forward function for FontDiffuser with content encoder style encoder and unet.
    """
...
class FontDiffuserModelDPM(ModelMixin, ConfigMixin):
    """
    DPM Forward function for FontDiffuser with content encoder style encoder and unet.
    DDPM ==> Denoising Diffusion Probabilistic Models ==> DPM 是通过逐步反向去噪的过程
    """
